...
namespace EveMailHelper.DataAccessLayer.Migrations
{
    ...
    [Migration("20240205132618_evesde1")]
    partial class evesde1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EveMailHelper.DataModels.Corporation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateFounded = new DateTime(2024, 2, 5, 14, 26, 17, 818, DateTimeKind.Local).AddTicks(5903),
                            Description = "Noname Default",
                            EveDeletedInGame = false,
                            EveId = 0,
                            EveLastUpdated = new DateTime(2024, 2, 5, 13, 26, 17, 818, DateTimeKind.Utc).AddTicks(5880),
                            MemberCount = 0,
                            Name = "Noname Default",
                            TaxRate = 0f,
            ...
            modelBuilder.Entity("EveMailHelper.DataModels.Sde.ChrRace", b =>
                {
                    b.Property<int>("EveId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EveMailHelper.DataModels.Sde.EveType", b =>
                {
                    ...
                    b.HasOne("EveMailHelper.DataModels.Sde.ChrRace", "Race")
                        .WithMany("InvTypes")
