...
namespace EveMailHelper.DataAccessLayer.Migrations
{
    ...
    [Migration("20240216110949_normalizedProductionCost3")]
    partial class normalizedProductionCost3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EveMailHelper.DataModels.Corporation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateFounded = new DateTime(2024, 2, 16, 12, 9, 49, 159, DateTimeKind.Local).AddTicks(3999),
                            Description = "Noname Default",
                            EveDeletedInGame = false,
                            EveId = 0,
                            EveLastUpdated = new DateTime(2024, 2, 16, 11, 9, 49, 159, DateTimeKind.Utc).AddTicks(3978),
                            MemberCount = 0,
                            Name = "Noname Default",
                            TaxRate = 0f,
            ...
            modelBuilder.Entity("EveMailHelper.DataModels.Market.NormalizedProductionCost", b =>
                {
                    b.Property<int>("EveTypeId")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("BestPriceComponentCost")
                        .HasColumnType("float");

                    b.Property<double>("BestPriceJobCost")
                        .HasColumnType("float");

                    b.Property<double>("BestPriceSum")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("float")
                        .HasComputedColumnSql("[BestPriceJobCost] + [BestPriceComponentCost]");

                    b.Property<double>("DirectComponentCost")
                        .HasColumnType("float");

                    b.Property<double>("DirectCostSum")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("float")
                        .HasComputedColumnSql("[DirectJobCost] + [DirectComponentCost]");

                    b.Property<double>("DirectJobCost")
                        .HasColumnType("float");
